...
class NGram(nn.Module):
    ...
    def __init__(self, params, emotion_embs):
        super().__init__()
        ...
        self.emotion_embs = emotion_embs / torch.norm(emotion_embs, dim=-1, keepdim=True)
    ...
    def forward(self, x, num_tokens):
        ...
        preds = torch.zeros(x.shape[0], self.num_segments, device=x.device)
